...
int input_read_parameters_species(struct file_content * pfc,
  ...
  class_read_double("z_mean",pba->z_mean); /* mean redshift in the gaussian change of rho_tot */ /*Poudou*/
  class_read_double("sigma_change",pba->sigma_change); /*standard deviation in the gaussian change of rho_tot */ /*Poudou*/
  class_read_double("gauss_amplitude",pba->gauss_amplitude); /*amplitude of the gaussian change of rho_tot */ /*Poudou*/


  if (pba->sigma_change !=0){ /* function for presence of gaussian change */ /*Poudou*/
     pba->has_gauss_change = _TRUE_ ;
  }
...
int input_default_params(struct background *pba,
  ...
  /** Gaussian change parameters */ /*Poudou*/
  pba->has_gauss_change = _FALSE_;
  pba->z_mean = 0.;
  pba->sigma_change = 0.;
  pba->gauss_amplitude = 1.;
