...
struct background
{
  ...
  double z_mean; /**< mean redshift in the gaussian change of rho_tot */ /*Poudou*/
  double sigma_change; /**< standard deviation in the gaussian change of rho_tot */ /*Poudou*/
  double gauss_amplitude; /**< amplitude of the gaussian change of rho_tot */ /*Poudou*/
  //@}
  ...
  short has_gauss_change; /**< presence of gaussian change in rho_tot? */ /*Poudou*/
